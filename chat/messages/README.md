...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/messages/1_create_idea/round_1/1_gen_hypo.md` — 64 messages
    - `chat/messages/1_create_idea/round_1/2_review_hypo.md` — 20 messages
  - round_2
    - `chat/messages/1_create_idea/round_2/1_gen_hypo.md` — 22 messages
    - `chat/messages/1_create_idea/round_2/2_review_hypo.md` — 16 messages
- **2. test_idea** — `invention_loop`
  - round_1
    - `chat/messages/2_test_idea/round_1/1_gen_strat.md` — 4 messages
    - `2_gen_plan/` — 2 task(s)
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 18 messages
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 17 messages
    - `3_gen_art/` — 2 task(s)
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 1 message
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 1 message
    - `chat/messages/2_test_idea/round_1/4_gen_paper_text.md` — 65 messages
...
- **3. report_results** — `gen_paper_repo`
  - `chat/messages/3_report_results/1_gen_full_paper.md` — 122 messages
